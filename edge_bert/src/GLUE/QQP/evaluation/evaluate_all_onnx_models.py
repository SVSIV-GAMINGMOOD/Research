...
from GLUE.QQP.common import compute_fp16_baseline_onnx_metrics, evaluate_onnx_model, load_qqp_dataset, total_onnx_size_mb
...
def main() -> None:
    dataset = load_qqp_dataset(format_type="numpy", max_samples=EVALUATION_SETTINGS["max_samples"])
    all_results = {}
