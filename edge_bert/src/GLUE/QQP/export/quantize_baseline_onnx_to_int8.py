...
from GLUE.QQP.task_config import baseline_fp32_onnx_path, baseline_int8_onnx_path
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="qqp.quant.") as tmp_dir:
    ...
    print(f"QQP INT8 uniform ONNX saved to {int8_path}")
